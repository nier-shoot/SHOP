...
<link rel="stylesheet" href="http://127.0.0.1/SHOP/shop/App/Shop/Admin/Tpl/Index/style/admin.css">
<script type='text/javascript' src='http://127.0.0.1/SHOP/hdphp/hdphp/Extend/Org/Jquery/jquery-1.8.2.min.js'></script>
<script type="text/javascript" src='http://127.0.0.1/SHOP/shop/App/Shop/Admin/Tpl/Index/style/js.js'></script>
</head>
<body>
    <div class="wrap1">
        <div class="wrap2">
                        ...
                        <div class="pass-login-pop-content">
                            <div class="pass-login-pop-form">
                                <div id="login_form" class="tang-pass-login">
                                    <form id="" class="pass-form" method="POST" autocomplete="off">
                                        <p id="" class="pass-generalErrorWrapper">
                                            <span id="" class="pass-generalError pass-generalError-error"></span>
                                        </p>
                                        ...
                                        <p id="" class="pass-form-item pass-form-item-userName" style="display:block">
                                            ...
                                            <input placeholder="手机/邮箱/用户名" id="TANGRAM__PSP_4__emall" name="userName" class="pass-text-input pass-text-input-userName" autocomplete="off" type="text">
                                        ...
                                        <p id="" class="pass-form-item pass-form-item-verifyCode">
                                            ...
                                            <span id="TANGRAM__PSP_4__verifyCodeImgParent" class="pass-verifyCodeImgParent"><img id="TANGRAM__PSP_4__verifyCodeImg" class="pass-verifyCode" src="%E7%99%BB%E5%BD%95_%E7%99%BE%E5%BA%A6%E8%B4%B4%E5%90%A7_files/small_blank_9dbbfbb1.gif"></span>
                                            <a id="TANGRAM__PSP_4__verifyCodeChange" href="#" class="pass-change-verifyCode">换一张</a>
