...
<link rel="stylesheet" href="__CONTROL_TPL__/style/admin.css">
<jquery/>
<script type="text/javascript" src='__CONTROL_TPL__/style/js.js'></script>
<script type="text/javascript">
     APP='__APP__';//加引号！！
    function CodeChange(){
            $('#CodeChange').attr("src","__CONTROL__/code/"+Math.random());
    }
</script>
</head>
<body>
                        ...
                        <div class="pass-login-pop-content">
                            <div class="pass-login-pop-form">
                                <div id="login_form" class="tang-pass-login">
                                    <form name="login_form" action="{|U('Login/login')}" class="pass-form" method="POST" autocomplete="off">
                                        ...
                                        <p id="" class="pass-form-item pass-form-item-verifyCode">
                                            ...
                                            <span class="pass-verifyCodeImgParent"><img id="CodeChange" onclick="this.src='__CONTROL__/code/'+Math.random()" class="pass-verifyCode" src="{|U:'code'}" ></span>
