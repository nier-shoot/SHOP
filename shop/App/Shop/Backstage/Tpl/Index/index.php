...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="__CONTROL_TPL__/css/unicorn.main.css" />
		<link rel="stylesheet" href="__CONTROL_TPL__/css/unicorn.grey.css" class="skin-color" />
	...
	<body>
		...
		<div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav btn-group">
                ...
                <li class="btn btn-inverse"><a title="" target="_self" href="{|U:'Login/out'}"><i class="icon icon-share-alt"></i> <span class="text">Logout</span></a></li>
            </ul>
        </div>
		...
		<div id="sidebar">
			...
			<ul>
				<li class="active"><a href="{|U:'index'}"><i class="icon icon-home"></i> <span>后台首页</span></a></li>
				<li class="submenu">
		...
		<div id="content">
            ...
            <script src="__CONTROL_TPL__/js/excanvas.min.js"></script>
            <script src="__CONTROL_TPL__/js/jquery.min.js"></script>
            <script src="__CONTROL_TPL__/js/jquery.ui.custom.js"></script>
            <script src="__CONTROL_TPL__/js/bootstrap.min.js"></script>
            <script src="__CONTROL_TPL__/js/jquery.flot.min.js"></script>
            <script src="__CONTROL_TPL__/js/jquery.flot.resize.min.js"></script>
            <script src="__CONTROL_TPL__/js/jquery.peity.min.js"></script>
            <script src="__CONTROL_TPL__/js/fullcalendar.min.js"></script>
            <script src="__CONTROL_TPL__/js/unicorn.js"></script>
            <script src="__CONTROL_TPL__/js/unicorn.dashboard.js"></script>
	</body>
</html>
